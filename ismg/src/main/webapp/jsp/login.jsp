...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | The Ultimate Multi-purpose Bootstrap Admin Dashboard Theme | Theme #5 | User Login 1</title>
        ...
        <link rel="shortcut icon" href="resources/css/favicon.ico" /> </head>
    <!-- END HEAD -->
        ...
        <div class="content">
            ...
            <form class="login-form" action="login.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="loginName" name="loginName" /> </div>
                <div class="form-group">
            ...
            <form class="register-form" action="register.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Full Name" name="realName" /> </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="work type" name="workType" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">work adress</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="work adress" name="workAdress" />
                </div>
                <p class="hint"> Enter your account details below: </p>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">loginName</label>
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="loginName" name="loginName" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
